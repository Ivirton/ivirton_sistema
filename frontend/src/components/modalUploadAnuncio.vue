                ...
                <div class="modal-body">
                    <form action="/upload" method="post" enctype="multipart/form-data">
                        <div class="linha">
                            ...
                            <div class="form-group">
                                <label for="duracao" class="col-form-label">Duracão</label>
                                <input class="form-control" value="20" type="number" style="width: 70px;" name="duracao"
                                    required id="duracao">
                            </div>
                            <div class="form-group">
                                <label for="imagem" class="col-form-label">Escolher Imagem</label>
                                <input type="file" class="form-control" style="width: 142px;" name="imagem" id="imagem"
                                    required>
                            </div>
                        </div>
